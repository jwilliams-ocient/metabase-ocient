(ns metabase-enterprise.enhancements.integrations.ldap
  ...
  (:require [metabase-enterprise.enhancements.ee-strategy-impl :as ee-strategy-impl]
            ...
            [metabase.public-settings.premium-features :as settings.premium-features :refer [defenterprise]]
            [metabase.util :as u]
...
(defenterprise find-user :- (s/maybe EEUserInfo)
...
(defenterprise fetch-or-create-user! :- (class User)
